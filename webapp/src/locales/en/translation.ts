export const enTranslation = {
  ...
  // Phone Register Page
  phoneRegister_title: "Create Account with Phone",
  phoneRegister_descriptionPhone: "Enter your phone number to receive a verification code",
  phoneRegister_descriptionOtp: "Enter the 4-digit code sent to your phone",
  phoneRegister_name: "Name (Optional)",
  phoneRegister_namePlaceholder: "John Doe",
  phoneRegister_requestCode: "Send Verification Code",
  phoneRegister_sending: "Sending...",
  phoneRegister_createAccount: "Create Account",
