export const enTranslation = {
  ...
  // Phone Login Page
  phoneLogin_title: "Sign in with Phone",
  phoneLogin_description: "Enter your phone number to receive a verification code",
  phoneLogin_requestCode: "Send Code",
  phoneLogin_verify: "Verify",
  phoneLogin_emailLoginLink: "Sign in with email",

  // Phone Register Page
  phoneRegister_title: "Sign up with Phone",
  phoneRegister_description: "Enter your phone number to get started",
  phoneRegister_requestCode: "Send Code",
