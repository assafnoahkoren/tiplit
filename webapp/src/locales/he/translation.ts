...
export const heTranslation: Translation = {
  ...
  auth_phonePlaceholder: "+972501234567 (פורמט E.164)",
  ...
  // Phone Login Page
  phoneLogin_title: "התחבר עם טלפון",
  phoneLogin_description: "הזן את מספר הטלפון שלך כדי לקבל קוד אימות",
  phoneLogin_requestCode: "שלח קוד",
  phoneLogin_verify: "אמת",
  phoneLogin_emailLoginLink: "התחבר עם אימייל",

  // Phone Register Page
  phoneRegister_title: "הירשם עם טלפון",
  phoneRegister_description: "הזן את מספר הטלפון שלך כדי להתחיל",
  phoneRegister_requestCode: "שלח קוד",
  phoneRegister_verify: "צור חשבון",
